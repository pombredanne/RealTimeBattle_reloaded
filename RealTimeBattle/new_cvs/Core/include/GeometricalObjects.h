...
public:
  ...
  virtual bool within_distance(const Vector2D& pos, const double size);
  ...
  //virtual void accept_visitor( ShapeVisitor*, bool, bool );
...
public:
  ...
  void set_center( const Vector2D& pos ) { center = pos; }
