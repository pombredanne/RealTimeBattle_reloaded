...
//! Option that robot send to the game to say how he wants informations 
/*! The values described in comments are the arguments */
enum robot_option_type
{
  ...
  RTB_1_1_X_COMPATIBLE=4      /*!< 0 - false, 1 - true
				assumed as false */
};
...
static const struct Message message_to_robot[25] = 
{
  ...
  {"TeamInfo",   2, {INT,    INT,    NONE,   NONE}},   // arg1: Your Id, arg2: Team Id 
  ...
  {"ExtendedGameOption", 2, {STRING, DOUBLE, NONE, NONE}}, 
  {"RobotEquipment", 3, {INT, STRING, STRING, NONE}},  // arg 1: id, 2: name, 3; definition of the equipment
  ...
  {"RobotInfo",  2, {DOUBLE, INT,    NONE,   NONE}},   // first arg: Other robots energylevel, second arg : useless (team mate)
  {"ExtraRobotInfo", 3, {DOUBLE, INT, INT, NONE}},     //  otherrobotenergy, robot id, robot team ?
  {"RotationReached",1,{STRING, NONE,  NONE,   NONE}},    // arg: what has finished rotation (see Rotate below) (ie "1,3.")
  ...
  {"TeamMessage",  1, {INT, STRING}},        // arg : sender id, message
...
static const struct Message message_from_robot[25] = 
{
  ...
  {"TeamMessage",1, {STRING, NONE, NONE, NONE}},
