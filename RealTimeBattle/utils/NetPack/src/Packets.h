...
const string NETPACK_RTB_PROTOCOL_VERSION_STR          = string("RTB_NETPACK_Server_devel");
const string NETPACK_RTB_PROTOCOL_TOURNAMENT_ROBOT     = string("RTB_NETPACK_Robot_0.0");
